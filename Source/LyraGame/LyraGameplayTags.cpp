...
namespace LyraGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_Confirm, "InputTag.ConfirmTargeting", "Confirms and ability's targeting.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_Cancel, "InputTag.CancelTargeting", "Cancels and ability's targeting.");
